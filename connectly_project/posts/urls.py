...
from posts.views.views import ProtectedView, UserListCreate, UserLogin, PostDetailView, CommentListCreate, \
    ...
    LatestPostsFeed, LatestPostsView, PublicPostsView, CreatePostView, MyPostsView
...
urlpatterns = [
    # Take all the routes generated by the router and include them at the root of this URLConf.
